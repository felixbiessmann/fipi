...
\section{Sentiment vs. Power}
\subsection{}

\begin{frame}{Sentiment correlates with political power}
\begin{center}
\only<1>{\includegraphics[width=0.7\textwidth]{images/party-sentiments-17}}
\only<2>{\includegraphics[width=0.7\textwidth]{images/party-sentiments-18}}
\only<3>{
\begin{table}[t]
\caption{
