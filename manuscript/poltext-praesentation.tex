...
\small
\begin{itemize}[<+->]
\item (For me) This is just a hobby / open source project
\item It has nothing to do with my job
\item I did not know a lot of literature in the field 
%\begin{itemize}
\item So some of this might sound naive (like the title)
...
\begin{block}{}
\centering
All hyperparameters optimised with {\bf nested} cross-validation.\footnote{This is not a technical detail. It's a crucial requirement for any ML system.}
\end{block}
\end{frame}
...
\hline
avg / total    &   0.73   &   0.71  &    {\bf 0.66}   &    200\\
\end{tabular}
\end{center}
\end{table}
}
...
\includegraphics[width=0.6\textwidth]{images/pydata-logo-berlin-2016}\\
\end{minipage}
