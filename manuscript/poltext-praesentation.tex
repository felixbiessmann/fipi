...
\bf Out-of-domain accuracy on manifesto data close to chance
...
\item Potential strategies to ensure generalization
\begin{itemize}
...
\end{itemize}
\item[$\rightarrow$] Using domain knowledge requires interpretable models
\end{itemize}
}
\end{frame}
...
\item Covariation Text Features and Party labels
...
\centering
\only<1>{\includegraphics[width=0.8\textwidth]{images/linksrechts-screenshot-1}}
\only<2>{\includegraphics[width=0.8\textwidth]{images/linksrechts-screenshot-2}}
\only<3>{\includegraphics[width=0.8\textwidth]{images/fipi-screenshot-2}}
\only<4>{\includegraphics[width=0.8\textwidth]{images/fipi-screenshot}}
\end{frame}
